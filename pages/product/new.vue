<template>
  <div class="h-screen w-full flex">
    <div class="my-auto mx-auto w-full px-10">
      <div class="">
        <input-element 
        ...
        <input-element 
          ...
          class="my-2"
        />
        <button type="button" class="bg-gray-50 text-grey-200 py-2 px-4 hover:bg-yellow-600 
        hover:text-gray-800" @click="createProduct">Create</button>
      </div>
    </div>
  </div>
</template>
